            ...
            <div class="table-responsive p-0">
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td> <h6 class="mb-0 text-sm m-3">{{$pelanggan->NamaPelanggan}}</h6> </td>
                    <td> <p class="text-xs text-secondary mb-0">{{$pelanggan->Alamat}}</p> </td>
                    <td> <p class="text-xs text-secondary mb-0">{{ $pelanggan->NoTlp }}</p> </td>
                    <td class="align-middle text-center text-sm">
                      <a href="/pelanggan/{{ $pelanggan->id }}/edit" class="badge badge-sm bg-gradient-success">
                        Edit
                      </a>
                      <a href="/pelanggan/{{ $pelanggan->id }}/hapus" class="badge badge-sm bg-gradient-danger">
                        Hapus
                      </a>
                    </td>
                  </tr>
